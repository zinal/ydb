...
* В [федеративных запросах](./concepts/query_execution/federated_query/) существенно расширен набор поддерживаемых внешних источников данных: добавлена поддержка [Prometheus](https://github.com/ydb-platform/ydb/pull/17148), [Apache Iceberg](https://github.com/ydb-platform/ydb/pull/17007), [OpenSearch](https://github.com/ydb-platform/ydb/pull/18444), [MongoDB](https://github.com/ydb-platform/ydb/pull/15335) и [Redis](https://github.com/ydb-platform/ydb/pull/16957). Кроме того, [YDB Topics можно использовать как внешний источник данных](https://github.com/ydb-platform/ydb/pull/18955), а также расширены возможности pushdown-предикатов, включая [`LIKE`](https://github.com/ydb-platform/ydb/pull/17695) и [`REGEXP`](https://github.com/ydb-platform/ydb/pull/19024).
* Существенно расширены возможности [векторных индексов](./dev/vector-indexes.md): добавлена [поддержка index-only search](https://github.com/ydb-platform/ydb/pull/18137), [поддержка обновлений для global vector index](https://github.com/ydb-platform/ydb/pull/22522), а также продолжена работа над [глобальной recompute-фазой в k-means индексации](https://github.com/ydb-platform/ydb/pull/19154).
* Подсистема [YDB Topics](./concepts/topic) и совместимость с Kafka получили заметное развитие: появились [компактифицированные топики в Kafka API](https://github.com/ydb-platform/ydb/pull/18683), [компактификация по ключу](https://github.com/ydb-platform/ydb/pull/23024), [idempotent producer](https://github.com/ydb-platform/ydb/pull/19678), [partition-level metrics](https://github.com/ydb-platform/ydb/pull/22572), [улучшения direct read в SDK](https://github.com/ydb-platform/ydb/pull/18263), [экспорт](https://github.com/ydb-platform/ydb/pull/18138) и [импорт](https://github.com/ydb-platform/ydb/pull/18214) конфигурации топиков через S3, а также расширенная поддержка offset, message metadata и диагностики ([#17682](https://github.com/ydb-platform/ydb/pull/17682)).
* Для [асинхронной репликации](./concepts/async-replication) расширены сценарии безопасности и эксплуатации: добавлена [поддержка IAM-аутентификации](https://github.com/ydb-platform/ydb/pull/25090) и [пользовательского CA](https://github.com/ydb-platform/ydb/pull/21448), описаны [уровни консистентности репликации](https://github.com/ydb-platform/ydb/pull/12365), улучшена поддержка [streaming query и DDL-ориентированных сценариев](https://github.com/ydb-platform/ydb/pull/24346), а также увеличено число партиций, создаваемых по умолчанию для сценариев репликации ([#21420](https://github.com/ydb-platform/ydb/pull/21420)).
* Подсистема выполнения запросов и планировщики получили заметное обновление. В YDB [переработан KQP CPU scheduler на базе HDRF](https://github.com/ydb-platform/ydb/pull/19618), [включён новый compute scheduler на базе HDRF](https://github.com/ydb-platform/ydb/pull/21997), а также расширены возможности интроспекции и управления. Для запросов и скриптов добавлены [runtime results](https://github.com/ydb-platform/ydb/pull/17421), [статус `running`](https://github.com/ydb-platform/ydb/pull/19134), [сохранение runtime AST](https://github.com/ydb-platform/ydb/pull/23817) и [увеличенные timeout по умолчанию](https://github.com/ydb-platform/ydb/pull/24456).
* Улучшена работа Shared Cache: реализована [двухуровневая модель кеширования с in-memory tier](https://github.com/ydb-platform/ydb/pull/19579), дополняющая другие изменения в кэше и уменьшающая стоимость повторного доступа к часто используемым страницам данных.
* Расширены административные и схемные возможности: можно [изменять лимиты схемных объектов через `ALTER DATABASE`](https://github.com/ydb-platform/ydb/pull/19580), [задавать `NOT NULL` ограничения в KQP](https://github.com/ydb-platform/ydb/pull/22406), [включать followers для вторичных индексов](https://github.com/ydb-platform/ydb/pull/17965), а также использовать дополнительные возможности управления правами, владельцами и форматами выдачи в QueryService.
* Существенно расширены средства наблюдаемости и эксплуатации. В YDB добавлены [настраиваемая конфигурация healthcheck](https://github.com/ydb-platform/ydb/pull/15693), [увеличенный до 10 КБ лимит текста запроса в system views](https://github.com/ydb-platform/ydb/pull/15186), [счётчики spilling queue](https://github.com/ydb-platform/ydb/pull/17394), [мониторинговые счётчики с постоянным значением для nodes, VDisks и PDisks](https://github.com/ydb-platform/ydb/pull/18731), дополнительные [атрибуты трассировки для Distributed Storage](https://github.com/ydb-platform/ydb/pull/21010), [cancellation для read iterators](https://github.com/ydb-platform/ydb/pull/19376), [maintenance API в CMS](https://github.com/ydb-platform/ydb/pull/15474) и [дополнительные maintenance-возможности в dstool](https://github.com/ydb-platform/ydb/pull/25237).
* Развиты cluster, storage и maintenance-сценарии: добавлены [базовая поддержка cluster bridging](https://github.com/ydb-platform/ydb/pull/18297), [2DC bridge arbiter](https://github.com/ydb-platform/ydb/issues/23455), [реконфигурация Board через DistConf](https://github.com/ydb-platform/ydb/pull/18859), [автоматическая реконфигурация StateStorage](https://github.com/ydb-platform/ydb/pull/17525), новые параметры blob-storage и PDisk, такие как [`GroupSizeInUnits` и `SlotSizeInUnits`](https://github.com/ydb-platform/ydb/pull/19337), [контрольные суммы VDisk](https://github.com/ydb-platform/ydb/pull/25106), [maintenance-статусы, запрещающие размещение новых VDisks](https://github.com/ydb-platform/ydb/pull/24608), и [replication-aware опции размещения дисков в dstool](https://github.com/ydb-platform/ydb/pull/20860).
* Улучшены безопасность, аутентификация и аудит: добавлены [интеграция с Google Breakpad и управление minidump](https://github.com/ydb-platform/ydb/pull/17362), [улучшения OIDC и расширенный ответ `whoami`](https://github.com/ydb-platform/ydb/pull/19674), [аудит monitoring HTTP API](https://github.com/ydb-platform/ydb/pull/21262), [дополнительные audit-события для YMQ](https://github.com/ydb-platform/ydb/pull/21183), [более подробный аудит `ALTER/MODIFY USER`](https://github.com/ydb-platform/ydb/pull/16989) и дополнительные механизмы cluster-level authorization.
* Улучшен CLI и общий developer experience: появились [автодополнение в CLI](https://github.com/ydb-platform/ydb/issues/9056), [progress reporting в `ydb sql` и workload-командах](https://github.com/ydb-platform/ydb/pull/16491), [дополнительные debug/latency-параметры CLI](https://github.com/ydb-platform/ydb/pull/17672), [mTLS client certificate options](https://github.com/ydb-platform/ydb/pull/8406), а также новые вспомогательные опции для `ydbd`, `dstool` и локального развёртывания.

#### Производительность

* Выполнение запросов к колоночным таблицам было ускорено за счёт [binary search для поиска границ предикатов в portions](https://github.com/ydb-platform/ydb/pull/16867), [расширенного pushdown фильтров в ColumnShard](https://github.com/ydb-platform/ydb/pull/17884), [улучшенного параллельного выполнения OLAP-запросов](https://github.com/ydb-platform/ydb/pull/20428), [улучшений shuffle elimination и планировщика](https://github.com/ydb-platform/ydb/pull/14901) и других оптимизаций execution path.
* Производительность записи и хранилища выросла за счёт [новой схемы приоритетов PDisk для realtime и compaction writes](https://github.com/ydb-platform/ydb/pull/21705), [оптимизации `TEvAssimilate`](https://github.com/ydb-platform/ydb/pull/25084), [изменений в `ArrayBufferMinFillPercentage`](https://github.com/ydb-platform/ydb/pull/25000), ускорения создания writing sessions и других изменений в write path.
* Эффективность выполнения и планирования повышена благодаря [constant folding для детерминированных UDF](https://github.com/ydb-platform/ydb/pull/17533), [кешу ответов SchemeNavigate](https://github.com/ydb-platform/ydb/pull/20128), [настройке `buffer_page_alloc_size`](https://github.com/ydb-platform/ydb/pull/19724), [удалению завершённых запросов из compute scheduler](https://github.com/ydb-platform/ydb/pull/22837), [улучшениям hash-join internals](https://github.com/ydb-platform/ydb/pull/23996) и дополнительным оптимизациям для TTL, topic writes и OLAP.
* Дополнительные улучшения производительности затронули и runtime/storage-компоненты, включая [Roaring UDF `Intersect`](https://github.com/ydb-platform/ydb/pull/17611), [shared metadata cache для column shards](https://github.com/ydb-platform/ydb/pull/18544) и внутренние настройки для compaction, scheduling и bulk-операций.

#### Исправления ошибок

* Исправлен широкий спектр проблем в OLAP и query engine: аварийные завершения и неверные результаты в scan-запросах, ошибки в `JOIN` compilation и shuffle logic, проблемы CTAS и query plans, обработка `DESC`, крайние случаи vector index, ошибки после удаления OLAP-таблиц в system views, path-resolution bugs, а также ряд гонок в ColumnShard и CPU limiter. В этот же класс вошли [crash после follower alter](https://github.com/ydb-platform/ydb/pull/24937), [гонки в QueryService и script execution](https://github.com/ydb-platform/ydb/pull/25191) и проблемы стабильности в s3/federated provider, такие как [multipart upload](https://github.com/ydb-platform/ydb/pull/25311).
* Исправлены проблемы в Topics, Kafka и replication-сценариях: гонки в read session и direct read, обработка offset, работа старых версий Kafka batches, replication/query errors в bridge mode, CDC-запись в auto-partitioned topics, значения по умолчанию в asynchronous replication и дополнительные проблемы стабильности в topic SDK и topic-to-table flows.
* Исправлены проблемы стабильности в storage и кластере: ошибки DSProxy timeout handling, false positives в Healthcheck, quorum и maintenance-state edge cases, crash в follower/tablet сценариях, logger races, а также различные assertion failures и segfault при restart, shutdown и работе в degraded cluster.
* Исправлены проблемы наблюдаемости, аудита и контроля доступа: поведение `RateLimiter` для несуществующих ресурсов, access checks в viewer и describe paths, инициализация audit, OIDC error reporting и actor lifecycle, а также UI/viewer-проблемы вокруг `whoami`, `capabilities`, storage и tablet introspection.
* Исправлен большой набор service/tooling edge cases в workload-командах, backup/restore, import/export, local deployment, progress reporting CLI, parser/AST handling и compatibility-сценариях. В частности, сюда входят [сохранение порядка колонок](https://github.com/ydb-platform/ydb/pull/18664), [корректное поведение `SHOW CREATE TABLE` для `VIEW`](https://github.com/ydb-platform/ydb/pull/16423) и обработка сложных кейсов при работе со script, secret и external source.

#### YDB UI

* В YDB UI и viewer обновлены механизмы аутентификации и capability checks, улучшена диагностика storage и tablets, а также исправлены такие проблемы, как [таймауты получения PDisk info](https://github.com/ydb-platform/ydb/pull/20432), [получение списка таблеток для объектов с secondary indexes](https://github.com/ydb-platform/ydb/pull/17157), [потеря точности при сериализации `double`](https://github.com/ydb-platform/ydb/pull/18056) и [дублирование данных при обработке входящих чанков](https://github.com/ydb-platform/ydb/pull/20929).
## Версия 25.2 {#25-2}
