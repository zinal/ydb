...
Ниже приведён черновой текст, который можно использовать как основу для speaker notes. Его не обязательно произносить дословно: часть формулировок лучше адаптировать под уровень аудитории, реальные слайды и конкретный контур эксплуатации.
