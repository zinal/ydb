...
* YDB expanded [federated query](./concepts/federated_query/) capabilities with support for new external data sources, including [Prometheus](https://github.com/ydb-platform/ydb/pull/17148), [Apache Iceberg](https://github.com/ydb-platform/ydb/pull/17007), [OpenSearch](https://github.com/ydb-platform/ydb/pull/18444), [MongoDB](https://github.com/ydb-platform/ydb/pull/15335), and [Redis](https://github.com/ydb-platform/ydb/pull/16957). YDB can also use [YDB Topics as an external source](https://github.com/ydb-platform/ydb/pull/18955), and federated execution gained support for additional pushdowns such as [`LIKE`](https://github.com/ydb-platform/ydb/pull/17695) and [`REGEXP`](https://github.com/ydb-platform/ydb/pull/19024).
* Analytical functionality was extended for [vector indexes](./dev/vector-indexes.md): YDB added [index-only search support](https://github.com/ydb-platform/ydb/pull/18137), [global vector index update support](https://github.com/ydb-platform/ydb/pull/22522), and continued work on [global recompute in k-means based indexing](https://github.com/ydb-platform/ydb/pull/19154).
* Caching and memory-management capabilities were extended further: YDB implemented a two-tier design in Shared Cache with an in-memory tier ([#19579](https://github.com/ydb-platform/ydb/pull/19579)), continued improving page-cache behavior and cleanup policies, and added more controls around memory usage and cache accounting across execution and storage components.
* [YDB Topics](./concepts/topic) and Kafka compatibility were significantly expanded: YDB added [compacted topics in Kafka API](https://github.com/ydb-platform/ydb/pull/18683), [topic compactification by key](https://github.com/ydb-platform/ydb/pull/23024), [idempotent producers](https://github.com/ydb-platform/ydb/pull/19678), [partition-level metrics](https://github.com/ydb-platform/ydb/pull/22572), [direct read improvements in the SDK](https://github.com/ydb-platform/ydb/pull/18263), support for [topic configuration export](https://github.com/ydb-platform/ydb/pull/18138) and [import via S3](https://github.com/ydb-platform/ydb/pull/18214), and wider support for offsets, message metadata, and diagnostics such as [custom message-size and last-offset handling](https://github.com/ydb-platform/ydb/pull/17682).
* [Asynchronous replication](./concepts/async-replication) was broadened: YDB added [IAM authentication support](https://github.com/ydb-platform/ydb/pull/25090) and [user-defined CA support](https://github.com/ydb-platform/ydb/pull/21448), documented [replication consistency levels](https://github.com/ydb-platform/ydb/pull/12365), improved support for [streaming query startup and DDL-driven workflows](https://github.com/ydb-platform/ydb/pull/24346), and increased the default replication topic partitioning to reduce later repartitioning delays ([#21420](https://github.com/ydb-platform/ydb/pull/21420)).
* Query execution and scheduling received a broad refresh. YDB [re-implemented the KQP CPU scheduler on the HDRF model](https://github.com/ydb-platform/ydb/pull/19618), [enabled the new HDRF-based compute scheduler](https://github.com/ydb-platform/ydb/pull/21997), and continued improving scheduler behavior and introspection. Query execution also gained [runtime results](https://github.com/ydb-platform/ydb/pull/17421), [`running` status support](https://github.com/ydb-platform/ydb/pull/19134), [runtime AST saving](https://github.com/ydb-platform/ydb/pull/23817), and configurable [longer default query timeouts](https://github.com/ydb-platform/ydb/pull/24456).
* Administrative and schema-management capabilities were extended: users can [change schema object limits with `ALTER DATABASE`](https://github.com/ydb-platform/ydb/pull/19580), [set `NOT NULL` constraints in KQP](https://github.com/ydb-platform/ydb/pull/22406), [enable followers for secondary indexes](https://github.com/ydb-platform/ydb/pull/17965), and use additional operations around ownership, grants, and query result formatting in QueryService.
* Observability and operational tooling were expanded. YDB added [customizable healthcheck configuration](https://github.com/ydb-platform/ydb/pull/15693), [10 KB query text limits in system views](https://github.com/ydb-platform/ydb/pull/15186), [spilling queue counters](https://github.com/ydb-platform/ydb/pull/17394), [constant-value counters for nodes, VDisks, and PDisks](https://github.com/ydb-platform/ydb/pull/18731), additional [Distributed Storage tracing attributes](https://github.com/ydb-platform/ydb/pull/21010), [read iterator cancellation](https://github.com/ydb-platform/ydb/pull/19376), [maintenance APIs in CMS](https://github.com/ydb-platform/ydb/pull/15474), and richer [dstool maintenance controls](https://github.com/ydb-platform/ydb/pull/25237).
* Cluster, storage, and maintenance features were also extended: YDB added [basic cluster bridging support](https://github.com/ydb-platform/ydb/pull/18297), [2DC bridge arbiter functionality](https://github.com/ydb-platform/ydb/issues/23455), [Board reconfiguration via DistConf](https://github.com/ydb-platform/ydb/pull/18859), [automatic StateStorage reconfiguration](https://github.com/ydb-platform/ydb/pull/17525), new blob-storage and PDisk controls such as [`GroupSizeInUnits` and `SlotSizeInUnits`](https://github.com/ydb-platform/ydb/pull/19337), [VDisk checksums](https://github.com/ydb-platform/ydb/pull/25106), [maintenance statuses that prevent allocation of new VDisks](https://github.com/ydb-platform/ydb/pull/24608), and [replication-aware disk placement options in dstool](https://github.com/ydb-platform/ydb/pull/20860).
* Security, authentication, and auditing were enhanced: YDB added [Google Breakpad integration and minidump controls](https://github.com/ydb-platform/ydb/pull/17362), [OIDC improvements and extended `whoami` responses](https://github.com/ydb-platform/ydb/pull/19674), [monitoring HTTP API audit logging](https://github.com/ydb-platform/ydb/pull/21262), [additional audit events for YMQ](https://github.com/ydb-platform/ydb/pull/21183), [more detailed `ALTER/MODIFY USER` audit records](https://github.com/ydb-platform/ydb/pull/16989), and richer access-resource handling for cluster-level authorization.
* Developer and CLI experience improved as well: YDB added [interactive CLI autocomplete](https://github.com/ydb-platform/ydb/issues/9056), [progress reporting in `ydb sql` and workload commands](https://github.com/ydb-platform/ydb/pull/16491), [additional debug/latency CLI options](https://github.com/ydb-platform/ydb/pull/17672), [mTLS client certificate options in CLI](https://github.com/ydb-platform/ydb/pull/8406), and a broader set of helper and discovery options in `ydbd`, `dstool`, and local deployment tooling.

#### Performance

* Query execution for column-oriented tables was accelerated by improvements such as [binary-search-based predicate bound detection in portions](https://github.com/ydb-platform/ydb/pull/16867), [wider filter pushdown into ColumnShard](https://github.com/ydb-platform/ydb/pull/17884), [improved parallel execution for OLAP queries](https://github.com/ydb-platform/ydb/pull/20428), [shuffle-elimination and planner improvements](https://github.com/ydb-platform/ydb/pull/14901), and other execution-path optimizations.
* Write- and storage-path performance improved through changes such as [new PDisk priority handling for realtime vs compaction writes](https://github.com/ydb-platform/ydb/pull/21705), [faster session creation and writing-session creation behavior](https://github.com/ydb-platform/ydb/pull/19807), [optimized `TEvAssimilate`](https://github.com/ydb-platform/ydb/pull/25084), [default `ArrayBufferMinFillPercentage` handling](https://github.com/ydb-platform/ydb/pull/25000), and selective retries for retryable batch and upload scenarios.
* Execution efficiency and scheduler behavior were improved by [constant folding for deterministic UDFs](https://github.com/ydb-platform/ydb/pull/17533), [a cache for SchemeNavigate responses](https://github.com/ydb-platform/ydb/pull/20128), [buffer-page allocation tuning](https://github.com/ydb-platform/ydb/pull/19724), [removal of finished queries from the compute scheduler](https://github.com/ydb-platform/ydb/pull/22837), [support for more efficient hash-join internals](https://github.com/ydb-platform/ydb/pull/23996), and a set of optimizations around TTL validation, topic writes, and OLAP execution.
* Several runtime and storage subsystems also received targeted performance improvements, including [Roaring UDF operations such as `Intersect`](https://github.com/ydb-platform/ydb/pull/17611), [shared metadata caches for column shards](https://github.com/ydb-platform/ydb/pull/18544), and internal tuning for compaction, scheduling, and bulk operations.

#### Bug Fixes

* Fixed numerous OLAP and query-correctness issues, including crashes and wrong results in scan queries, `JOIN` compilation and shuffle logic, CTAS and query plans, `DESC` processing, vector-index edge cases, dropped OLAP tables in system views, path-resolution bugs, and a number of ColumnShard and CPU-limiter races. These fixes also covered [follower alter crashes](https://github.com/ydb-platform/ydb/pull/24937), [query-service and script-execution races](https://github.com/ydb-platform/ydb/pull/25191), and stability problems in s3/federated providers such as [multipart uploads](https://github.com/ydb-platform/ydb/pull/25311).
* Fixed topics, Kafka, and replication issues, including read-session and direct-read races, offset handling, batch processing for older Kafka batch versions, replication/query errors in bridge mode, CDC writes into auto-partitioned topics, asynchronous replication defaults, and multiple stability issues in topic SDK and topic-to-table flows.
* Fixed storage and cluster stability issues across Distributed Storage, DistConf, CMS, Healthcheck, VDisk/PDisk handling, followers, and Hive. This includes timeout handling in DSProxy, healthcheck false positives, quorum and maintenance-state issues, tablet and follower crashes, logger races, and several assertions or segfaults seen during restart, shutdown, or degraded-cluster operation.
* Fixed observability, auditing, and access-control problems, including `RateLimiter` behavior on nonexistent resources, access checks in viewer and describe paths, audit initialization checks, OIDC error reporting and actor lifecycle issues, and UI/viewer failures around `whoami`, `capabilities`, storage, and tablet introspection.
* Fixed a broad set of service- and tooling-level issues in workload commands, backup/restore, import/export, local deployment, CLI progress reporting, parser/AST handling, and compatibility behavior. These fixes include [support for preserving column order](https://github.com/ydb-platform/ydb/pull/18664), [avoiding `SHOW CREATE TABLE` misuse on views](https://github.com/ydb-platform/ydb/pull/16423), and improved handling of edge cases in scripts, secrets, and external sources.

#### YDB UI

* Updated YDB UI and viewer behavior for authentication and capability checks, improved storage and tablet introspection, and fixed issues such as [PDisk info timeouts](https://github.com/ydb-platform/ydb/pull/20432), [tablet list retrieval for objects with secondary indexes](https://github.com/ydb-platform/ydb/pull/17157), [precision loss during serialization](https://github.com/ydb-platform/ydb/pull/18056), and [data duplication during chunk handling](https://github.com/ydb-platform/ydb/pull/20929).
## Version 25.2 {#25-2}
